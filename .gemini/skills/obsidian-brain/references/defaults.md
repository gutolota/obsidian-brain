...
Write this to `~/.gemini/obsidian-brain/config.md` if it doesn't exist:
...
After creating, **inform the user**: _"Created default config at `~/.gemini/obsidian-brain/config.md`. Please edit it to set your real vault path before running again."_

## Default brain-rules.md

Write this to `~/.gemini/obsidian-brain/brain-rules.md` if it doesn't exist:
