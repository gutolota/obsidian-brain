...
Read:
- `~/.gemini/obsidian-brain/config.md`
- `~/.gemini/obsidian-brain/brain-rules.md`
...
📄 Files
   Config:  ~/.gemini/obsidian-brain/config.md
   Rules:   ~/.gemini/obsidian-brain/brain-rules.md
```
...
- _"Edit `~/.gemini/obsidian-brain/config.md` to change vault path or behavior."_
- _"Edit `~/.gemini/obsidian-brain/brain-rules.md` to adjust rules manually, or use the learn command to add new ones."_
