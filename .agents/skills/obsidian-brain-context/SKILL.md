...
Read `~/.agents/obsidian-brain/workspace-links.md` and look for an entry matching the current working directory.
...
From `~/.agents/obsidian-brain/config.md`, get the vault path.
