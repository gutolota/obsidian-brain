...
Read:
- `~/.agents/obsidian-brain/config.md`
- `~/.agents/obsidian-brain/brain-rules.md`
...
📄 Files
   Config:  ~/.agents/obsidian-brain/config.md
   Rules:   ~/.agents/obsidian-brain/brain-rules.md
```
...
- _"Edit `~/.agents/obsidian-brain/config.md` to change vault path or behavior."_
- _"Edit `~/.agents/obsidian-brain/brain-rules.md` to adjust rules manually, or use the learn command to add new ones."_
